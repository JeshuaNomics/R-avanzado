...
```r
library(bench)
#> Warning: package 'bench' was built under R version 4.1.2
```
...
#> 3 .Internal(mean(x))   35.1us   44.9us    18493.
```
...
#> 3 lookup[x100]    5.9us    9.7us    97707.
```
